    ...
    return (
        <TouchableOpacity onPress={props.onPress}
            ...
            <View style={tailwind`w-1/6 justify-start items-center mt-2`}>
                <View style={tailwind`w-8 h-8 rounded-full bg-gray-200 justify-center items-center`}>
                    {profilePic === null ?
                        <Text style={tailwind`font-semibold text-sm mt-0.5`}>{userName.charAt(0)}</Text>
                        :
